      ...
      <section className="mt-4 grid grid-cols-3 gap-4 lg:grid-cols-4 xl:grid-cols-5">
        ...
        {sports?.map(({ label, url, image }, idx) => (
          ...
          >
            ...
            >
              <div className="z-1 absolute right-full top-0 flex h-full w-full items-center justify-center bg-image duration-300 group-hover:right-0">
                Click here!
              </div>
              <div className="z-1 absolute left-0 top-0 flex h-full w-full items-center justify-center bg-pink duration-300 group-hover:left-full">
                Play Game
              </div>
            </button>
