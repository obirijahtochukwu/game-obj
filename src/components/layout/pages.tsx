...
export default function Pages({ pages, pathname, extreme }: { extreme?: boolean } & any) {
  return (
    <div
      className={`${extreme ? "left-full ml-4" : "left-14"} invisible absolute -top-10 flex h-fit w-0 overflow-x-hidden rounded-md bg-advance opacity-0 drop-shadow-[0px_0px_6px_#ffffff30] duration-500 group-hover:visible group-hover:w-44 group-hover:opacity-100`}
    >
