  ...
  return (
    <article className="w-full overflow-x-auto custom-scrollbar bg-advance mt-7 rounded-md border border-gray">
      ...
      {Array(7)
        .fill("")
        .map((e, idx) => (
          <div className="w-fit min-w-full flex gap-14 items-center justify-between text-white text-sm font-medium pr-7 h-10 even:bg-dark ">
            <div
            ...
            >
              ...
              <div className="w-28">Christine Brooks</div>
            </div>
